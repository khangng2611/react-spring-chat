    ...
    return (
        <div className="col-start-1 col-end-10 px-3 rounded-lg">
            <div className="flex flex-row items-end">
                <div className={`flex items-center justify-center h-10 w-10 rounded-full ${AVATAR_COLORS.at(message.senderId % AVATAR_COLORS.length)} flex-shrink-0 text-sm overflow-hidden`} >
                    {onlineUsers.get(message.senderId)?.fullName[0].toUpperCase()}
                </div>
